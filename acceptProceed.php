        ...
        <div id="main">
            ...
            <div class="page-heading">
              ...
              <?php 
				...
				$query="select * from proceed where isActive='0' and proceedId='$user'";
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                   ...
                                                   <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="number" id="first-name" class="form-control"
                                                            name="buyPrice" value="<?php echo $row['sell']; ?>" readonly>
                                                    </div>
														
                                                    <div class="col-sm-12 d-flex justify-content-end">
														<input type="hidden" name="proceed" value="<?php echo $row['proceedId'];?>">
                                                        <button type="submit"
