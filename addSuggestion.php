                        ...
                        <div class="col-md-6 col-6">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post" action="suggestionAction.php" enctype="multipart/form-data">
                                            <div class="form-body">
                                                <div class="row">
                                                   ...
                                                   <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="number" id="first-name" class="form-control"
                                                            name="sellPrice" placeholder="Enter amount per Kg">
                                                    </div>
														
														
                                                    <div class="col-sm-12 d-flex justify-content-end">
                                                        <button type="submit"
                                                            class="btn btn-primary me-1 mb-1">SUGGEST</button>
