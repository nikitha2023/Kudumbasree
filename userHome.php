                                    ...
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                           ...
                                           <img src="product/<?php echo $row['images']; ?>" width="200" height="150"><br>
											...
											<p><b> ₹<?php echo $row['sell']; ?>/- per Kg</b></p>

                                            <form action="addtocart.php" method="post">
                                                <input type="text" name="qty" required class="form-control form-control-user"
                                                       placeholder="Enter Qty" />


                                                <input type="hidden" name="pid" value=" <?php echo $row['itemName'];?>">

                                                <input type="hidden" name="price" value=" <?php echo $row['sell'];?>">
                                                <br>
                                                <div align="center"> <input type="submit" value="Add to Cart" class="btn btn-sm btn-warning"/>
                                                </div>
