...
<head>
    ...
    <title>Kudumbasree Login Page</title>
        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <form method="post" action="kudumbasreeLoginAction.php">
                        <div class="form-group">
                            <label><b>REGISTRATION NUMBER</b></label>
                            <input type="text" name="regNo" class="form-control" placeholder="Enter Your Registration Number">
                        </div>
                            <div class="form-group">
